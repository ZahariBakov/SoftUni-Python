...
SECRET_KEY = 'django-insecure-w@f6oq6xq&r0m#rkh_lzrdkz+zyxz9oq^%2^6-2@0=d6@=1@dc'
...
INSTALLED_APPS = [
    ...
    'user_managment_demos.web',
    'user_managment_demos.app_auth',
]
...
ROOT_URLCONF = 'user_managment_demos.urls'
...
WSGI_APPLICATION = 'user_managment_demos.wsgi.application'

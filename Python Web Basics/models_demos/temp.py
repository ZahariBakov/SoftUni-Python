...
class WebEmployee(models.Model):
    ...
    is_full_time = models.BooleanField(blank=True, null=True)
    department = models.ForeignKey(WebDepartment, models.DO_NOTHING)
...
class WebEmployeeProjects(models.Model):
    id = models.BigAutoField(primary_key=True)
    ...
    class Meta:
        managed = False
        db_table = 'web_employee_projects'
        unique_together = (('employee', 'project'),)


class WebEmployeesprojects(models.Model):
    id = models.BigAutoField(primary_key=True)
    date_joined = models.DateField()
    employee_id = models.ForeignKey(WebEmployee, models.DO_NOTHING)
    project_id = models.ForeignKey('WebProject', models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'web_employeesprojects'
...
class WebProject(models.Model):
    ...
    code_name = models.CharField(unique=True, max_length=10)
